		...
		<div class="w-full lg:w-6/12 px-4">
			<div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white border-0">
				...
				<div class="flex-auto px-4 lg:px-10 py-10 pt-0">
					<form method="post" action="<?= BURL ?>shortener/update_link/<?= $row['id'] ?>" enctype="multipart/form-data">
						...
						<div class="relative w-full mb-3">
							<label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="grid-password">URL</label>
							<input value="<?= $row['url'] ?>" type="text" name="url" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" placeholder="URL" style="transition: all 0.15s ease 0s;" />
						</div>
