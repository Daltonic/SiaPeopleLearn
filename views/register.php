<main>
  <section class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 20vh;">
    ...
    <div class="w-full lg:w-8/12 my-6 px-4">
      <div class="relative min-w-0 break-words w-full shadow-lg rounded-lg bg-gray-100 flex flex-col lg:flex-row items-center justify-center">
        <div class="w-full lg:w-1/2 z-10 flex flex-col justify-center items-center space-y-4">
          <img class="hidden sm:block w-64" src="<?= BURL ?>assets/student.png" alt="Student">
          <div class="text-gray-600 text-center w-full lg:w-2/3 space-y-2">
            <h4 class="text-md font-bold">Join Dapp Mentors Academy</h4>
            <p class="text-sm">
              Become one of the earliest members of this exclusive platform and get ready
              to access a ton of our courses and premium video content.
            </p>
          </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 z-10">
          ...
          <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
            <form method="post" action="<?= BURL ?>authentication/register">
              <div class="relative w-full mb-3">
                <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="grid-password">Firstname</label><input require type="text" name="firstname" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" placeholder="Firstname" style="transition: all 0.15s ease 0s;" />
              </div>
              <div class="relative w-full mb-3">
                <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="grid-password">Lastname</label><input require type="text" name="lastname" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" placeholder="Lastname" style="transition: all 0.15s ease 0s;" />
              </div>
              <div class="relative w-full mb-3">
              ...
              <div class="text-center mt-6">
                <button class="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full" type="submit" name="<?= $this->token ?>">Register</button>
              </div>
              <div class="flex justify-between items-center flex-wrap">
              <a href="<?= BURL ?>forget" class="text-gray-900"><small>Forgot password?</small></a>
              <a href="<?= BURL ?>login" class="text-gray-900"><small>Login Instead</small></a>
            </div>
            </form>
          </div>
        </div>
